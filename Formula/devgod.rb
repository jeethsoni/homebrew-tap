class Devgod < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "sha256:ad78292f89fd178cdd6bf01411c8637a2a7e9a6869e78e2e3d84251ee1a64c83"
    else
      url "https://github.com/jeethsoni/devgod-cli/releases/download/v0.1.0/devgod_darwin_amd64"
      sha256 "sha256:63644891c0daa174552bb476be94f2b7f94a0a2b2c3b9eff69701d653a803002"
    end
  end
